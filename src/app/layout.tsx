...
const RECLAIM_CLEARANCE_CONTRACT =
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="description"
          content="Connect your inbox, prove your innocence, support survivors."
        />
        <meta
          name="viewport"
        ...
        <meta
          property="og:image"
          content="https://theredactedfile.com/og-image.png"
        />
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Inter:wght@400;500;600;700;800;900&family=JetBrains+Mono:wght@400;500;700&display=swap"
          rel="stylesheet"
        />
      </head>
